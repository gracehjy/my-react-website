        ...
        <ExperienceRow>
          <ExperienceCard
            ...
            >
                ...
                <Description>
                As a former TA for Logic & Discrete Mathematics and a current TA for Data Structures & Algorithms and Object-Oriented Software Development Laboratory, I spend most of my time at school conducting weekly office hours to answer students' questions and to assist them on problem sets, and I also grade and provide feedback on students' exams and assignments.
            ...
            >
                ...
                <Description>
                Working at <Link to="https://dsri.uiowa.edu/">NADS</Link> as a high school intern, I spent most of my time learning from my peers and mentors. The simulations studied consisted of drivers taking on specific tasks and tracking where their eyes moved during those tasks. By the end of this internship, I had developed a batch-processing method 
                using Python to clean 1000+ unstructured eye-tracking pixel data, and I had determined generalized areas where the drivers would frequently glance to by dividing the pixel data into quadrants and visualizing that data using various statistical models.
                </Description>
                </Reveal>
            </ExperienceCard>
        </ExperienceRow>
